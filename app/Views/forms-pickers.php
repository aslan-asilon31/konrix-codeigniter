...
<head>
    <?php echo view('partials/title-meta', array('title' => 'Picker')); ?>
    ...
    <div class="flex wrapper">
        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <?php echo view('partials/page-title', array('subtitle' => 'Form', 'title' => 'Picker')); ?>
                ...
                <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            ...
                            <div id="HumanFriendlyPickerHtml"
                                class="hidden w-full overflow-hidden transition-[height] duration-300">
                                <pre class="language-html h-auto">
                                    <code>
                                        &lt;input type=&quot;text&quot; class=&quot;form-input&quot; id=&quot;datepicker-humanfd&quot;&gt;
