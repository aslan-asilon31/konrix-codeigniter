<div class="app-menu">
    ...
    <div class="srcollbar" data-simplebar>
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                <a href="apps-tickets" class="menu-link">
            ...
            <li class="menu-item">
                <a href="apps-file-manager" class="menu-link">
            ...
            <li class="menu-item">
                <a href="apps-kanban" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="apps-project-list" class="menu-link">
                            <span class="menu-text">List</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="apps-project-detail" class="menu-link">
                            <span class="menu-text">Detail</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="apps-project-create" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    ...
                    <li class="menu-item">
                        <a href="auth-recoverpw" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    ...
                    <li class="menu-item">
                        <a href="pages-gallery" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="pages-404-alt" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="layout-hover-view" target="_blank" class="menu-link">
                            <span class="menu-text">Hovered Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layout-icon-view" target="_blank" class="menu-link">
                            <span class="menu-text">Icon View Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layout-compact-view" target="_blank" class="menu-link">
                            <span class="menu-text">Compact Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layout-mobile-view" target="_blank" class="menu-link">
                            <span class="menu-text">Mobile View Menu</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layout-hidden" target="_blank" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="ui-accordions" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="ui-breadcrumbs" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="ui-dismissible" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="ui-skeleton" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="ui-ratio" class="menu-link">
                            <span class="menu-text">Ratio</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="ui-tabs" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="ui-popovers" class="menu-link">
                            <span class="menu-text">Popovers</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="ui-tooltips" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="extended-swiper" class="menu-link">
                            <span class="menu-text">Swiper</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-nestable" class="menu-link">
                            <span class="menu-text">Nestable List</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-ratings" class="menu-link">
                            <span class="menu-text">Ratings</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-animation" class="menu-link">
                            <span class="menu-text">Animation</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-player" class="menu-link">
                            <span class="menu-text">Player</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-scrollbar" class="menu-link">
                            <span class="menu-text">Scrollbar</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-sweet-alert" class="menu-link">
                            <span class="menu-text">Sweet Alert</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-tour" class="menu-link">
                            <span class="menu-text">Tour Page</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-tippy-tooltips" class="menu-link">
                            <span class="menu-text">Tippy Tooltip</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="extended-lightbox" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    ...
                    <li class="menu-item">
                        <a href="forms-select" class="menu-link">
                            <span class="menu-text">Select</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="forms-range" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="forms-masks" class="menu-link">
                            <span class="menu-text">Masks</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="forms-editor" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="forms-layout" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="icons-mingcute" class="menu-link">
                            <span class="menu-text">Mingcute</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="icons-feather" class="menu-link">
                            <span class="menu-text">Feather</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="icons-material-symbols" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="sub-menu hidden">
                    <li class="menu-item">
                        <a href="docs-introduction" class="menu-link">
                            <span class="menu-text">Introduction</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="docs-installation" class="menu-link">
                            <span class="menu-text">Installation</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="docs-customization" class="menu-link">
                            <span class="menu-text">Customization</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="docs-changelog" class="menu-link">
