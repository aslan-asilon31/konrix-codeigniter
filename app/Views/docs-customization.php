    ...
    <div class="flex wrapper">
        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <?php echo view('partials/page-title', array('subtitle' => 'Documentation', 'title' => 'Customization')); ?>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Dark Demo</h4>
                        </div>
                        <div class="p-6">
                            <p>
                                Konrix provides the Dark Mode support as well. You will simply
                                add attribute in html tage.
                            </p>
                            <p>
                                simply change the reference of update the html
                                tag with attribute <code>data-mode="dark"</code>. E.g.
                                <code>&lt;html lang=&quot;en&quot;
                                    data-mode=&quot;r&quot;&gt;</code>
                            </p>
                        </div>
